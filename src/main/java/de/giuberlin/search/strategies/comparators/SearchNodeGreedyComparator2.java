...
public class SearchNodeGreedyComparator2 implements Comparator<SearchNode>  {
    GridObject goal;

    public SearchNodeGreedyComparator2(GridObject goal) {
        this.goal = goal;
    }
    ...
    public int compare(SearchNode node1, SearchNode node2) { //compare  between h1 of node 1 and 2
        ...
        int costCompare = Long.compare(node1H.getHeuristicManhattan(),  node2H.getHeuristicManhattan());
